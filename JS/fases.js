export const fases = {
    ...
    opcoes: [
        ...
        { texto: "Se afastar e atacar poderoso raio de luz.", proximaTela: "Tela 7", pontuacao: 2   }
    ]
},
    ...
    "Tela 22": {
        texto: "As fadas emitem um som triste, como um acorde menor em uma melodia, e a líder balança a cabeça lentamente. — Não, Edalyn. A resposta correta não era essa. Infelizmente, você falhou no teste. A fada líder olha para ela com compaixão, mas sua expressão é firme. — As regras são claras, Edalyn. Não podemos conceder a cura a quem não prova ser digno. Mas saiba que sua jornada não foi em vão. A sabedoria que você busca está dentro de você, mesmo que ainda não a tenha encontrado.",
        opcoes: [
    ...
    "Tela 23": {
        ...
        opcoes: []  // Fim do jogo, conseguiu a cura.
    },
    "Tela 24": {
